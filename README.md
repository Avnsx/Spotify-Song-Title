...
I'm fully aware that there's an Spotify API that will exactly replicate the functionality of this code, but it requires you to run the official Spotify client, which I'm not doing, my Spotify user data is never going back to the Spotify Server, which makes it impossible for me to use their API. And for everyone else that has the same issue or you just don't want to deal with their API, you're welcome to use this repo 🎉
